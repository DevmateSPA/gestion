...
public class DetalleFacturaRepository : BaseRepository<Detalle>, IDetalleFacturaRepository
{
    public DetalleFacturaRepository(IDbConnectionFactory connectionFactory)
