...
public class DetalleOrdenTrabajoRepository : BaseRepository<Detalle>, IDetalleOrdenTrabajoRepository
{
    public DetalleOrdenTrabajoRepository(IDbConnectionFactory connectionFactory)
